...
const ChatWidget: React.FC = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    { text: 'أهلاً بك! أنا مساعدك الذكي في منصة زايد، كيف يمكنني مساعدتك اليوم؟', isBot: true }
  ]);
        ...
        <div className="w-[350px] md:w-[420px] h-[550px] bg-slate-50 rounded-[2.5rem] shadow-2xl border border-white flex flex-col overflow-hidden">
          ...
          <div className="p-6 bg-white border-t border-emerald-50 flex gap-3">
            <input 
              ...
              className="flex-1 bg-slate-50 px-7 py-5 rounded-[2rem] text-sm font-black border border-slate-100 focus:outline-none focus:ring-2 focus:ring-emerald-500 transition-all shadow-inner"
            />
            <button 
              onClick={handleSend}
